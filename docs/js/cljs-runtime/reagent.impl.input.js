...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__12384){
var map__12385 = p__12384;
var map__12385__$1 = cljs.core.__destructure_map(map__12385);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12385__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var _STAR_force_set_dom_value_STAR__orig_val__12386 = reagent.impl.input._STAR_force_set_dom_value_STAR_;
var _STAR_force_set_dom_value_STAR__temp_val__12387 = true;
(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__temp_val__12387);
...
}finally {(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__orig_val__12386);
}}));
} else {
...
(jsprops.onChange = (function (p1__12395_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__12395_SHARP_);
}));
