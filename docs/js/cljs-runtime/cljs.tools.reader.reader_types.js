...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_11958 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_11958(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_11963 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_11963(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11970 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11970(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11976 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11976(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11979 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11979(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11985 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11985(reader);
}
});
...
var G__12002 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__12003 = s.append(c);
c = G__12002;
s = G__12003;
continue;
}
