...
var or__5002__auto__ = (function (){var G__12247 = c;
var G__12247__$1 = (((G__12247 == null))?null:G__12247.constructor);
if((G__12247__$1 == null)){
return null;
} else {
return G__12247__$1.displayName;
}
})();
...
var G__12248 = c;
var G__12248__$1 = (((G__12248 == null))?null:G__12248.constructor);
if((G__12248__$1 == null)){
return null;
} else {
return G__12248__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__12251 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__12252 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__12252);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__12251);
}});
...
var c = this;
var G__12268_12381 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__12268_12381 == null)){
} else {
reagent.ratom.dispose_BANG_(G__12268_12381);
}
...
var renders_12382 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_12383 = cljs.core.first(cljs.core.vals(renders_12382));
...
if((cljs.core.count(renders_12382) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_12382))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_12383)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_12383], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__12326 = o;
reagent.impl.component.goog$module$goog$object.set(G__12326,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__12343 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__12344 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__12344);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__12343);
}});
...
var vec__12349 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12349,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12349,(1),null);
...
var G__12356 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__12356 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__12356);
}
});
}),[]);
