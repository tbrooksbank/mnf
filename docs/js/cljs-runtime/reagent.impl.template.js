...
var G__12432 = o;
reagent.impl.template.goog$module$goog$object.set(G__12432,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
while (G__12500__i < G__12500__a.length) {G__12500__a[G__12500__i] = arguments[G__12500__i + 0]; ++G__12500__i;}
  args = new cljs.core.IndexedSeq(G__12500__a,0,null);
} 
...
var G__12438 = o;
reagent.impl.template.goog$module$goog$object.set(G__12438,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__12440 = props;
var G__12440__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12440,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__12440);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12440__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__12448 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12448,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__12448;
}
})(),id_class);
...
var G__12450 = (cljs.core.count(argv) - first_child);
switch (G__12450) {
case (0):
...
var vec__12453 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12453,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12453,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12453,(2),null);
...
var temp__5808__auto___12520 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___12520 == null)){
} else {
var key_12521 = temp__5808__auto___12520;
(jsprops.key = key_12521);
}
...
var temp__5808__auto___12522 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___12522 == null)){
} else {
var key_12523 = temp__5808__auto___12522;
(jsprops.key = key_12523);
}
...
var temp__5808__auto___12524 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___12524 == null)){
} else {
var key_12526 = temp__5808__auto___12524;
(jsprops.key = key_12526);
}
...
var temp__5808__auto___12533 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___12533 == null)){
} else {
var key_12534 = temp__5808__auto___12533;
(jsprops.key = key_12534);
}
...
var temp__5808__auto___12535 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___12535 == null)){
} else {
var key_12537 = temp__5808__auto___12535;
...
var ctx = ({});
var vec__12469 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12469,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12469,(1),null);
...
break;
default:
var G__12545 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__12546 = compiler;
v = G__12545;
compiler = G__12546;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template12485 = (function (opts,id,fn_to_element,parse_fn,meta12486){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template12485.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12487,meta12486__$1){
var self__ = this;
var _12487__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template12485(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta12486__$1));
}));

(reagent.impl.template.t_reagent$impl$template12485.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12487){
var self__ = this;
var _12487__$1 = this;
return self__.meta12486;
}));

(reagent.impl.template.t_reagent$impl$template12485.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template12485.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template12485.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template12485.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template12485.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template12485.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta12486","meta12486",1732728749,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template12485.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template12485.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template12485");

(reagent.impl.template.t_reagent$impl$template12485.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template12485");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template12485.
 */
reagent.impl.template.__GT_t_reagent$impl$template12485 = (function reagent$impl$template$__GT_t_reagent$impl$template12485(opts,id,fn_to_element,parse_fn,meta12486){
return (new reagent.impl.template.t_reagent$impl$template12485(opts,id,fn_to_element,parse_fn,meta12486));
});
...
return (new reagent.impl.template.t_reagent$impl$template12485(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
