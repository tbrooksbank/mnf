...
var i_14379 = (0);
while(true){
if((i_14379 < arr.length)){
(arr[i_14379] = null);

var G__14380 = (i_14379 + (1));
i_14379 = G__14380;
continue;
} else {
}
...
var i_14398 = (self__.level + (1));
while(true){
if((i_14398 <= (new_level + (1)))){
(update[i_14398] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_14402 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14402[i]));
} else {
x__$2.forward.push((((i < links_14402.length))?(links_14402[i]):null));
}

if((i < links_14402.length)){
(links_14402[i] = x__$2);
} else {
links_14402.push(x__$2);
}
...
var i_14410 = (0);
while(true){
if((i_14410 <= self__.level)){
var links_14413 = (update[i_14410]).forward;
if((x__$1 === (((i_14410 < links_14413.length))?(links_14413[i_14410]):null))){
(links_14413[i_14410] = (x__$1.forward[i_14410]));

var G__14416 = (i_14410 + (1));
i_14410 = G__14416;
continue;
} else {
var G__14417 = (i_14410 + (1));
i_14410 = G__14417;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__14432 = nx;
var G__14433 = (level__$1 - (1));
x = G__14432;
level__$1 = G__14433;
continue;
} else {
var G__14434 = x;
var G__14435 = (level__$1 - (1));
x = G__14434;
level__$1 = G__14435;
continue;
}
